...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { book_id: @wishlist.book_id, distance: @wishlist.distance, name: @wishlist.name, notice: @wishlist.notice, shop_id: @wishlist.shop_id, url: @wishlist.url }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { book_id: @wishlist.book_id, distance: @wishlist.distance, name: @wishlist.name, notice: @wishlist.notice, shop_id: @wishlist.shop_id, url: @wishlist.url }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
